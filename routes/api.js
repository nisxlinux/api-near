...
var creatorList = ['@_l_.lawliet_','@lsbot_'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'chat di wa.me/6289819810402 untuk mendapatkan apikey'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'chat di wa.me/6289819810402 untuk mendapatkan apikey'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Llawliet'+'Near-NgabS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'nearngab') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'nearngab') return res.json(loghandler.invalidKey)
